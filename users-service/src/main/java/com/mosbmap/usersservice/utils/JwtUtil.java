...
public class JwtUtil {
    ...
    public String generateToken(Session session) {
        ...
        return doGenerateToken(claims, session.getId());
    }
    ...
    public Boolean validateToken(String token, Session session) {
        final String sessionId = getSessionIdToken(token);
        return (sessionId.equals(session.getId()) && !isTokenExpired(token));
    }
